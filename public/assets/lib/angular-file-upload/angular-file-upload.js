...
var angularFileUpload = angular.module('angularFileUploadProfile', []);
...
angularFileUpload.service('$upload', ['$http', '$rootScope', '$timeout', function($http, $rootScope, $timeout) {
	...
	this.upload = function(config) {
		...
		} else if (config.file) { // Do not why there were no way to send data without files :-( Fixed manually.
