...
(function () {
    ...
    templates['operation'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        function program20(depth0, data) {
            ...
            return "\n          <div class='sandbox_header'>\n            <input class='submit btn btn-success' name='commit' type='button' value='Try it out!' />\n            <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n            <img alt='Throbber' class='response_throbber' src='/assets/lib/swagger/images/throbber.gif' style='display:none' />\n          </div>\n          ";
        }
        ...
        buffer += escapeExpression(stack1)
            + "'>\n      <div class='heading grid-title no-border descriptive clickable'>\n        <h3>\n          <span class='http_method'>\n          <a href='#!/";
        if (stack1 = helpers.parentId) {
            stack1 = stack1.call(depth0, {hash: {}, data: data});
        }
        else {
        ...
        buffer += "</a>\n          </li>\n        </ul>\n      </div>\n      <div class='content grid-body  no-border' id='";
        if (stack1 = helpers.parentId) {
            stack1 = stack1.call(depth0, {hash: {}, data: data});
        }
        else {
        ...
        buffer += "\n        </form>\n        <div class='response form-actions' style='display:none'>\n          <h4>Request URL</h4>\n          <div class='block request_url'></div>\n          <h4>Response Body</h4>\n          <div class='block response_body'></div>\n          <h4>Response Code</h4>\n          <div class='block response_code'></div>\n          <h4>Response Headers</h4>\n          <div class='block response_headers'></div>\n        </div>\n      </div>\n    </li>\n  </ul>\n";
        return buffer;
    });
})();
    ...
    ResourceView = (function (_super) {
        ...
        ResourceView.prototype.addOperation = function (operation) {
            ...
            operationView = new OperationView({
                model: operation,
                tagName: 'li',
                className: 'endpoint grid simple no-border'
            });
